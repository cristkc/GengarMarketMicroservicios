package com.gengarmarket.autentificacion.exception;

import com.gengarmarket.autentificacion.dto.ErrorDTO;
...
public class ManejadorErrores {
    ...
    public ResponseEntity<ErrorDTO> manejarBadRequest(
        ...
        Map<String, String> errores = new HashMap<>();
        errores.put("auth", ex.getMessage());
    ...
    public ResponseEntity<ErrorDTO> manejarErrorGeneral(
        ...
        Map<String, String> errores = new HashMap<>();
        errores.put("error", "Ocurrió un error interno en el servidor");
